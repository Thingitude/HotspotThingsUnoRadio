...
const byte appEui[8] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x00, 0x04, 0xCD }; //for example: {0x70, 0xB3, 0xD5, 0x7E, 0xE0, 0xE0, 0x01, 0x4A1};
const byte appKey[16] = { 0x58, 0x15, 0xD4, 0xF0, 0x40, 0x87, 0x82, 0xAD, 0x66, 0x72, 0x17, 0xD2, 0xDD, 0x5B, 0xC5, 0x49 };
